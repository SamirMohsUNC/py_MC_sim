...
def main():
    print("Interactive Monte Carlo Portfolio Risk Simulation")
    ...
    print(f"\nRunning Monte Carlo simulation for a {horizon}-day horizon...")
    losses = simulate_portfolio_losses(mu, sigma, weights, T=horizon, N=10000)
